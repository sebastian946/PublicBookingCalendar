...
const initialAppointments: Appointment[] = [
  {
    ...
    time: '09:00 AM',
    date: 'Today, Oct 25',
    patient: { name: 'John Doe', id: '#P-10294', initials: 'JD', color: 'bg-blue-100 text-primary' },
  ...
  },
  {
    ...
    time: '10:30 AM',
    date: 'Today, Oct 25',
    patient: { name: 'Alice Wong', id: '#P-10452', initials: 'AW', color: 'bg-orange-100 text-orange-600' },
  ...
  },
  {
    ...
    time: '01:15 PM',
    date: 'Today, Oct 25',
    patient: { name: 'Robert Johnson', id: '#P-09881', initials: 'RJ', color: 'bg-gray-100 text-gray-600' },
...
export function AdminProvider({ children }: { children: ReactNode }) {
  ...
  const rebookAppointment = (id: string) => {
    setAppointments(prev =>
      prev.map(apt => (apt.id === id ? { ...apt, status: 'pending' as AppointmentStatus } : apt))
    );
  };
