...
export function BookingConfirmation() {
  ...
  const serviceName =
    services[bookingData.selectedService]?.name || "General Consultation";
  const serviceDuration =
    services[bookingData.selectedService]?.duration || "30 min";
  return (
    <div className="bg-background-light min-h-screen">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border bg-white px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          ...
          <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border border-gray-200 bg-primary/20" />
        </div>
      </header>
      ...
      <main className="max-w-[1280px] mx-auto py-8 px-4 sm:px-10">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-text-primary text-3xl font-bold leading-tight pb-2">
            Booking Confirmation Journey
          </h1>
          <p className="text-text-secondary">
            Review how your patients see their appointment confirmation on-site
            and in their inbox.
          </p>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-border p-8 flex flex-col gap-6">
              ...
              <div className="flex flex-col items-stretch justify-start rounded-xl border border-gray-100 bg-background-light overflow-hidden">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&h=250&fit=crop")',
                  }}
                />
                <div className="flex w-full flex-col gap-3 p-5">
                  ...
                  <div className="flex flex-col gap-2 border-t border-gray-200 pt-3">
                    ...
                    <div className="flex items-center gap-2 text-text-secondary">
                      <span className="material-symbols-outlined text-sm">
                        {bookingData.visitMethod === "virtual"
                          ? "videocam"
                          : "person"}
                      </span>
                      <p className="text-sm">
              ...
              <div className="bg-blue-50 p-4 rounded-lg flex gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>
                    Please arrive 15 minutes early with your ID and insurance
                    card. If this is your first visit, you may complete your
                    intake forms online.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-100 px-4 py-3 border-b border-border flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium">
                    MedBook Pro &lt;no-reply@medbookpro.com&gt;
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-xs font-bold text-gray-500 uppercase">
                  ...
                  <span className="text-sm font-bold">
                    Confirmed: Your appointment with Dr. Julian Smith
                  </span>
                </div>
              </div>
                ...
                <div className="max-w-[500px] w-full bg-white shadow-sm rounded-sm overflow-hidden border border-gray-100">
                  ...
                  <div className="p-8">
                    <p className="text-lg mb-4">
                      Hello {bookingData.fullName.split(" ")[0] || "Patient"},
                    </p>
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      Your appointment has been successfully scheduled. We look
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm font-bold">
                            {formatDateShort(bookingData.selectedDate)}
                          </p>
                    ...
                    <div className="flex flex-col gap-3">
                      <a
                        href="#"
                        className="block w-full bg-primary text-white text-center py-3 rounded-lg font-bold text-sm"
                      >
                        Add to Calendar (.ics)
                      </a>
                      <div className="flex gap-2">
                        <a
                          href="#"
                          className="flex-1 bg-white text-gray-700 text-center py-2 border border-gray-200 rounded-lg text-xs font-bold"
                        >
                          Reschedule
                        </a>
                        <a
                          href="#"
                          className="flex-1 bg-white text-red-600 text-center py-2 border border-red-100 rounded-lg text-xs font-bold"
                        >
                          Cancel
                        </a>
                      </div>
        ...
        <div className="mt-16">
          <h2 className="text-text-primary text-xl font-bold leading-tight pb-6 pt-5">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-6 py-4 text-text-primary text-sm font-bold border-b border-border">
                    Channel
                  </th>
                  <th className="px-6 py-4 text-text-primary text-sm font-bold border-b border-border">
                    Primary Goal
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  ...
                  <td className="px-6 py-5 text-sm text-text-secondary leading-normal">
                    Asynchronous record of appointment with direct calendar
                    integration.
                  </td>
                  <td className="px-6 py-5 text-sm text-text-secondary leading-normal">
      ...
      <footer className="mt-20 border-t border-border py-10 bg-white">
        <div className="max-w-[1280px] mx-auto px-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-gray-400">
            © 2023 MedBook Pro. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
